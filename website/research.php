...
?>
			...
			<!-- Main Content Table -->
				...
				<div id="leadInPic"><img src="img/research_leadIn.jpg" alt="doc_banner" /></div>
					...
					<tr>
						<td style="width: 686px;">
							...
							<div id="mainBody"> 
								...
								<h3>The Story of ProveIt</h3>
								<h4>Wikipedia Citations are Important</h4>
								...
								<h4>Creating Citations are Cumbersome</h4>
								<p>ProveIt is an open-source Wikipedia referencing tool.  Quisque et leo ac lacus faucibus pellentesque et ac dui. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut sodales adipiscing sem at viverra. Cum sociis natoque penatibus et magnis dis parturient montes, </p>
						...
						<td> 
							...
							<div id="sideTableofContents">
								<h3 class="first">GT Conference</h3>
								<ul>
									<li><a href="#"> Paper 1 Link </a></li>
									<li><a href="#"> Paper 2 Link</a></li>
								</ul>
								...
								<h3> Documents</h3>
								<ul>
									<li><a href="#">Item with title #1</a></li>
									<li><a href="#">Item with title #2</a></li>
								</ul>
							</div>
					  </td>
					</tr>
