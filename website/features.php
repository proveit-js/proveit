					...
					<tr>
						<td id="mainContent">
							...
							<div id="mainBody"> 
								...
								<p>There's more to ProveIt than meets the eye. Adding, editing, viewing, and locating references on Wikipedia has never been this easy. </p>
								
								<h2>Easily create, edit, and find references</h2>

								<h3>Use most popular citation formats</h3>
								<ul>
								...
								<h3>There when you need it, gone when you don&rsquo;t</h3>
								<ul>
								...
								<h3>Instantly find the reference you want</h3>
								<ul>
								...
								<h3>No need to memorize complex syntax</h3>
								<ul>
								...
								<h3>References with multiple citations -- no longer a headache</h3>
								<ul>
								...
								<h3>Create valid references and fix ones that aren&rsquo;t</h3>
								<ul>
