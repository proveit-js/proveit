					...
					<tr>
						<td id="mainContent">
							...
							<div id="mainBody"> 
								...
								<p>ProveIt is a free, open-source referencing tool that makes it really easy to find, edit, add, and cite references in Wikipedia articles. ProveIt only needs to be installed once and can be accessed from any computer and any web browser.</p>	
