...
?>
			<!-- Main Content Table -->
				...
				<div id="leadInPic"><img src="img/wikipedia_referencing_simplified.jpg" alt="referencingSimplified" /></div>
					...
					<tr>
						...
						<td> 
							...
							<div id="sideTableofContents">
								<h3 class="first"> Completely Open-Source</h3>
								<ul>
                                	<li><a href="#">Get ProveIt Now for Free </a></li>
									<li><a href="#">Contribute and ImproveIt</a></li>
								</ul>
                                
                                <h3> Referencing Made Easy</h3>
                                <ul>
                                	<li><a href="#">Create and Edit References</a></li>
									<li><a href="#">Clean, Accurate Code </a></li>
                                    <li><a href="#">Automatic Wikipedia Formatting </a></li>
								</ul>
                                
                                <h3> Test Drive ProveIt</h3>
                                <ul>
									<li><a href="#"> Demo ProveIt -- RIGHT NOW!</a></li>
                                </ul>    
							</div>
                            ...
                            <h3 class="first">Getting Started</h3>
								<ul>
									<li><a href="#"> Setting Up ProveIt </a></li>
									<li><a href="#"> Locating References</a></li>
								</ul>
                                <h3>Using ProveIt</h3>
								<ul>
									<li><a href="#"> Adding References</a></li>
									<li><a href="#"> Editing References</a></li>
                                    <li><a href="#"> Adding an Ibid.</a></li>
								</ul>	
                            </div>
