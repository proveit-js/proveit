					...
					<tr>
						<td id="mainContent">	
							...
							<div id="mainBody">
								...
								<h3 id="find-ref">Find and Highlight a Reference</h3>
								...
								<h3 id="edit-ref">Edit a Reference</h3>
								...
								<h3 id="add-ref">Add a New Reference</h3>
								...
								<h3 id="minimize-proveit">Minimize ProveIt</h3>
