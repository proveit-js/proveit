				...
				<table id="mainTable">
					<tr>
						<td id="mainContent">
							...
							<div id="mainPic" class="credits">
								<h1>Credits</h1>
							</div><!-- end #mainPic -->
							<div id="mainBody"> 

							<p>Besides core <a href="/about/team">team members</a>, ProveIt depends on the efforts of <a href="/users/reportabug">issue reporters</a> and others providing feedback.  It also relies on the following code and resources:</p>
